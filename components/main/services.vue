<template>
  <section class="container">
    <div class="relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto xl:px-0 mt-5">
            ...
            <div class="relative h-full ml-0 md:mr-10">
              ...
              <div class="relative h-full p-5 bg-white border-2 border-purple-500 rounded-lg">
                ...
                <p class="mb-2 text-gray-600">
                  ...
                  focus on understanding and analyzing data to provide a semantic web.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="relative h-full ml-0 mr-0 sm:mr-10">
              ...
              <div class="relative h-full p-5 bg-white border-2 border-blue-400 rounded-lg">
                ...
                <p class="mb-2 text-gray-600">
                  ...
                  to assess the extent up to which project management standards are being upheld.
                </p>
              </div>
            </div>
          </div>
